(custom-set-variables
 ...
 '(package-selected-packages
   '(robe cider clj-refactor lsp-java moody pandoc-mode pandoc clojure-mode-extra-font-locking clojure-mode dashboard multiple-cursors rbenv ansible helm-system-packages jest esup package-utils peep-dired flycheck-plantuml lsp-pyright git-gutter py-autopep8 crux easy-kill lsp-ivy pretty-lambdada python-black py-isort counsel-osx-app racket-mode seeing-is-believing tide prettier-js company-quickhelp ac-geiser flycheck-clj-kondo yasnippet-snippets yaml-mode xwwp which-key web-mode use-package-ensure-system-package try treemacs-projectile treemacs-magit treemacs-icons-dired texfrag smartparens smart-hungry-delete slime-company ruby-electric rg rainbow-delimiters quelpa-use-package pyvenv python-pytest python-docstring projectile-ripgrep popwin plantuml-mode ob-http neotree modus-vivendi-theme modus-operandi-theme minions minimap magit-todos lsp-ui julia-mode json-mode ivy-rich ivy-prescient ivy-posframe inf-ruby helpful go-mode gnuplot glsl-mode git-messenger forge flycheck-color-mode-line fireplace eyebrowse expand-region exec-path-from-shell elfeed dockerfile-mode dired-subtree counsel-projectile company-restclient company-box company-auctex buffer-move anzu add-node-modules-path))
