(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (flycheck-pkg-config benchmark-init pdf-tools org-pdftools pdftools leuven-theme dockerfile-mode dap-mode company-lsp lsp-mode pyenv-mode elpy paredit-everywhere paredit-everywhere-mode org-plus-contrib web-mode company-box smartparens dimmer indium company-tern tern json-navigator yaml-mode dashboard doom-modeline anzu spacemacs-light spacemacs-theme ubuntu-theme yasnippet-snippets yasnippet-classic-snippets undo-tree kotlin-mode gradle-mode let-alist dired-subtree flycheck-flow graphql-mode ivy-rich rust-mode chess git-messenger all-the-icons-ivy intero all-the-icons-dired all-the-icons counsel-projectile gnuplot tide clj-refactor engine-mode company-tabnine company-flow flow-minor-mode projectile-ripgrep rg git-gutter+ git-gutter-+ add-node-modules-path flycheck-clj-kondo :nyan-mode company-auctex ox-latex ox-beamer auc-tex eyebrowse org-tempo elfeed xref-js2 fireplace ace-window edit-indirect nyan-mode smart-hungry-delete hungry-delete expand-region minimap glsl-mode elm-yasnippets org-reveal minions dracula-theme solarized-theme neotree go-mode haskell-mode ruby-electric inf-ruby elm-mode try which-key use-package htmlize restclient json-mode sml-mode markdown-mode tagedit rainbow-delimiters projectile paredit magit exec-path-from-shell clojure-mode-extra-font-locking cider)))
